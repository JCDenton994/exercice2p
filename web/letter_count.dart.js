...
$$.InputElement = {"": "_HTMLElement;value%"};
...
// Bound closures
$$.BoundClosure$1 = {"": "BoundClosure;_self,_target,_liblib0$_receiver",
  call$1: function(p0) {
    return this._self[this._target](p0);
  }
};

$$.BoundClosure$0 = {"": "BoundClosure;_self,_target,_liblib0$_receiver",
  call$0: function() {
...
BoundClosure: {"": "Closure;_self,_target,_liblib0$_receiver",
  $eq: function(_, other) {
    if (other == null)
      return false;
    if (this === other)
  ...
  get$hashCode: function(_) {
    return $.get$hashCode$(this._self) + $.get$hashCode$(this._target) + $.get$hashCode$(this._liblib0$_receiver) & 0x3ffffff;
  },
  $isBoundClosure: true
},
...
Sort_sort: function(a, compare) {
  $.Sort__doSort(a, 0, $.get$length$asx(a) - 1, compare);
},
...
NoSuchMethodError: {"": "Error_StackTraceOnThrow1;_receiver,_memberName,_arguments,_namedArguments,_existingArgumentNames",
  toString$0: function(_) {
    var t1, t2, t3, t4;
    t1 = {};
...
["letter_count.dart", "letter_count.dart", , {
main_closure: {"": "Closure;zoneTexte_0,listeLettres_1",
  call$1: function(e) {
    var text = $.get$value$x(this.zoneTexte_0);
    $.set$value$x(this.listeLettres_1, $.S(new $.main__letterFrequency().call$1(text)) + " \n" + $.S(text));
  }
},

main__letterFrequency: {"": "Closure;",
  call$1: function(text) {
    var charList, charMap, t1, $char;
    charList = $.replaceAll$2$s(text, $.RegExp_RegExp("\\W+", true, false), "").split("");
    $.JSArray_methods.sort$1(charList, new $.main__letterFrequency_closure());
    charMap = $.makeLiteralMap([]);
    for (t1 = $.JSArray_methods.get$iterator(charList); t1.moveNext$0();) {
      $char = t1._current;
      charMap.$indexSet(charMap, $char, $.$add$ns(charMap.putIfAbsent$2($char, new $.main__letterFrequency_closure0()), 1));
    }
    return charMap;
  }
},

main__letterFrequency_closure: {"": "Closure;",
  call$2: function(m, n) {
    return $.compareTo$1$ns(m, n);
  }
},

main__letterFrequency_closure0: {"": "Closure;",
  call$0: function() {
    return 0;
  }
},

main_closure0: {"": "Closure;zoneTexte_2,listeLettres_3",
  call$1: function(e) {
    $.set$value$x(this.zoneTexte_2, "");
    $.set$value$x(this.listeLettres_3, "");
  }
},

main: function() {
  var zoneTexte, listeLettres, boutonCalculer, boutonEffacer;
  zoneTexte = $.document().querySelector("#Texte");
  listeLettres = $.document().querySelector("#Lettres");
  boutonCalculer = $.document().querySelector("#Calculer");
  boutonEffacer = $.document().querySelector("#Effacer");
  $.get$onClick$x(boutonCalculer).listen$1(new $.main_closure(zoneTexte, listeLettres));
  $.get$onClick$x(boutonEffacer).listen$1(new $.main_closure0(zoneTexte, listeLettres));
}}],
]);
...
//@ sourceMappingURL=letter_count.dart.js.map
